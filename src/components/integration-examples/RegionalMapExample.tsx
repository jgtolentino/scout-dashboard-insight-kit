...
import PhilippinesChoroplethMap from '@/components/maps/PhilippinesChoroplethMap';
...
interface RegionalMapExampleProps {
  title?: string;
  data?: RegionalData[];
}

const RegionalMapExample: React.FC<RegionalMapExampleProps> = ({ 
...
export default RegionalMapExample;