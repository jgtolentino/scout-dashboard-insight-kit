  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 p-6 space-y-6 bg-gradient-to-br from-slate-50 to-blue-50 overflow-auto">
        ...
        {/* Behavior Analysis and AI Assistant */}
          ...
          <div className="lg:col-span-1">
            <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg h-full">
              <CardContent className="p-0 h-full">
                <AIAgent 
                  initialPrompt="I'm your Consumer Behavior Analyst. I can help you understand customer shopping patterns, preferences, and behaviors. What would you like to know about your customers?"
                  title="Behavior Analyst AI"
                  description="Specialized in consumer behavior patterns"
                />
              </CardContent>
            </Card>
          </div>
